        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <nav class="flex flex-col mt-4 space-y-2 text-sm text-gray-400">
                <a class="hover:opacity-75" href> Coaching </a>
                <a class="hover:opacity-75" href> Our Portfolio </a>
                <a class="hover:opacity-75" href> How Laeds Works </a>
                <a class="hover:opacity-75" href> Our Blog </a>
