    ...
    return (
        <form className="mt-10" onSubmit={handleSubmit}>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
                <div className="relative z-0">
                    <input required autoComplete="none"
                        ...
                        className="peer block w-full appearance-none border-0 border-b border-[#d0ff05] bg-transparent py-2.5 px-0 text-sm text-gray-300 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                ...
                <div className="relative z-0 col-span-2">
                    <textarea
                        ...
                        rows="5"
                        className="peer block w-full appearance-none border-0 border-b border-[#d0ff05] bg-transparent py-2.5 px-0 text-sm text-gray-300 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" "></textarea>
            ...
            <motion.div
                ...
                <div className='mt-5 border-[3px] border-[#912CC9] opacity-75 hover:opacity-100'>
                    <div className=' bg-[#912CC9] border border-[#912CC9] m-1'>
                        <input
